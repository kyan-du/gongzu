...
export const LEVELS: Level[] = [
  ...
  { id: 'zoo-hard', title: '14 动物园管理员', subtitle: '老虎会伤羊、羊会吃草；狗会追猫、猫会抓鸟；船坐 3 个，管理员必须掌舵。', capacity: 3, needsDriver: true, items: [
  ...
  { id: 'pairs-hard', title: '15 四组配对挑战', subtitle: '四组家长孩子都要过河；船坐 2 人，孩子不能离开自己的家长，和别的家长同岸。', capacity: 2, items: [
