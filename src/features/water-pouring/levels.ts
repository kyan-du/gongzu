...
export const WATER_LEVELS: WaterLevelDef[] = [
  ...
  { id: 'eight-twentyfive-four', title: '8 长链差量', subtitle: '用 8L 和 25L 杯量出 4L，要沿着差量一步步逼近。', target: { amount: 4 }, optimalMoves: 30, jugs: [{ id: 'a', name: '8L杯', capacity: 8, color: c(0) }, { id: 'b', name: '25L杯', capacity: 25, color: c(1) }] },
  { id: 'nine-twentyfive-eight', title: '9 大容量烧脑', subtitle: '用 9L 和 25L 杯量出 8L，步骤很长，别急着重置。', target: { amount: 8 }, optimalMoves: 30, jugs: [{ id: 'a', name: '9L杯', capacity: 9, color: c(0) }, { id: 'b', name: '25L杯', capacity: 25, color: c(1) }] },
