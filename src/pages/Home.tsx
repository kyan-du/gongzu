      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="relative" ref={menuRef}>
            ...
            {showMenu && (
              <div className="absolute right-0 top-full mt-1 w-44 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50 origin-top-right animate-[dropdown_0.15s_ease-out]">
