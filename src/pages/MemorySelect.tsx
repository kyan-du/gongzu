    ...
    <Layout userId={userId || ''} showBack backTo={`/${userId}/home`} maxWidth="max-w-2xl">
      <div className="flex flex-col items-center py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-4xl">
          ...
          {/* 杀手数独 */}
          <button onClick={() => navigate(`/${userId}/brain/killer-sudoku`)} className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden active:scale-[0.98] p-6"><div className="absolute inset-0 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 opacity-0 group-hover:opacity-100 transition-opacity" /><div className="relative flex flex-col items-center"><div className="w-16 h-16 mb-3 flex items-center justify-center bg-amber-100 dark:bg-amber-900/30 rounded-2xl group-hover:scale-110 transition-transform"><span className="text-4xl">🔢</span></div><h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">杀手数独</h2><p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-3">数独规则加小笼求和</p><div className="flex items-center gap-2 text-xs"><span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-full font-medium">小宫排除</span><span className="px-2 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 rounded-full font-medium">求和推理</span></div></div></button>

          {/* 数和填字 */}
          <button onClick={() => navigate(`/${userId}/brain/kakuro`)} className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden active:scale-[0.98] p-6"><div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-fuchsia-50 dark:from-purple-900/10 dark:to-fuchsia-900/10 opacity-0 group-hover:opacity-100 transition-opacity" /><div className="relative flex flex-col items-center"><div className="w-16 h-16 mb-3 flex items-center justify-center bg-purple-100 dark:bg-purple-900/30 rounded-2xl group-hover:scale-110 transition-transform"><span className="text-4xl">🧩</span></div><h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">数和填字</h2><p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-3">按横竖提示和填数字</p><div className="flex items-center gap-2 text-xs"><span className="px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-full font-medium">组合求和</span><span className="px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-full font-medium">交叉推理</span></div></div></button>

          {/* 高楼谜题 */}
          <button
            onClick={() => navigate(`/${userId}/brain/skyscrapers`)}
            className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden active:scale-[0.98] p-6"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-900/10 dark:to-blue-900/10 opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="relative flex flex-col items-center">
              <div className="w-16 h-16 mb-3 flex items-center justify-center bg-sky-100 dark:bg-sky-900/30 rounded-2xl group-hover:scale-110 transition-transform"><span className="text-4xl">🏙️</span></div>
              <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-2">高楼谜题</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center mb-3">根据四边视线提示填楼高</p>
              <div className="flex items-center gap-2 text-xs"><span className="px-2 py-1 bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-400 rounded-full font-medium">空间视角</span><span className="px-2 py-1 bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-400 rounded-full font-medium">排列推理</span></div>
            </div>
            <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity"><div className="w-8 h-8 rounded-full bg-sky-500 flex items-center justify-center"><svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></div></div>
          </button>
